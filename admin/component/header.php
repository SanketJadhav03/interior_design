...
<head>
  ...
  <?php
  $base_url = 'http://' . $_SERVER['HTTP_HOST'] . '/interior_design/admin/';
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item ">
          <a class="btn bg-info mx-2 font-weight-bold" href="<?= $base_url . "profile.php" ?>">
            <i class="fas fa-user mr-1"></i>  Hi, Admin
          </a>
        </li>
        <li class="nav-item ">
