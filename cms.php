   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-12">
            <div class="terms-box">
               <h3>You must not</h3>
               <p>Republish material form InteriorDesign .com<br>
                  Sell, rent or sub-license material form https:InteriorDesign .com<br>
                  Reproduce, duplicate or copy material form InteriorDesign .com<br>
                  Redistribute content from InteriorDesign (unless content is specifically made for redistribution).
               </p>
            </div>
         </div>
         <div class="col-md-12">
            <div class="terms-box">
               ...
               <p>This Agreement shall begin on the date hereof. <br>
                  Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. InteriorDesign does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions ofInteriorDesign , its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws InteriorDesign shall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.<br>
                  InteriorDesign reserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.<br>
                  ...
                  You hereby grant to InteriorDesign a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
               </p>
               ...
               <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to info@InteriorDesign .com. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
         ...
         <div class="col-md-12">
            <div class="terms-box">
               ...
               <p>By use of the uniform resource locator (Web address) being liked to; or<br>
                  ...
                  No use of InteriorDesign 's logo or other artwork will be allowed for linking absent a trademark license agreement.
               </p>
